...
<?php if ($comments) : ?>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	?>
&nbsp;&nbsp;<a href="<?php echo wp_logout_url(get_permalink()); ?>" title="退出账户"><?php print '[ 退出账户 ]'; ?></a> <?php cancel_comment_reply_link('[ 取消回复 ]'); ?>
	...
	<div id="comment-author-info">
		<p>
			...
			<input type="text" name="url" id="url" class="respondtext" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" placeholder="www.yuxiaoxi.com" pattern="((http|https)://|)+([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?"/>
		</p>
	</div>
      <?php endif; ?>
    <div class="clear"></div>
